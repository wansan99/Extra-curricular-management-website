...
<%--                        amend contact and emailaddress only--%>
                        <p><%= rs.getString("contact")%></p>
                        <p><%= rs.getString("emailaddress")%></p>
                    </div>
                </div>
            </div>
            <a href="dashboardMyProfile.jsp"><button>Back</button></a>
            <a href="dashboardMyProfileEdit.jsp?sid=<%= rs.getString("studentid")%>.jsp"><button>Update</button></a>
        </div>
        <%
            }
        %>
