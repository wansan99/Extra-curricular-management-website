...
<div class="wrapper">
    ...
    <div class="mainContent" id="main">
        ...
        <div id="directory" style="display: flex; margin: 20 0 0 50;">
            ...
            <h4> > </h4>
            <div><a href="">Committee Board</a></div>
        </div>
        ...
        <div class="csDetailContent">
            <div class="club">
                ...
                <div class="operation">
                    <a href="clubProfile.jsp?cid=<%=rs.getString("id")%>"><button style="border-right: none;">About</button></a>
                ...
                <%
                    ...
                    String datai = "select * from clubcommittee where clubid ='" + cid + "'";
